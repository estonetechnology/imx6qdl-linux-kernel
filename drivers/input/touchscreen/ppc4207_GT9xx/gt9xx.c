...
static s8 gtp_request_input_dev(struct goodix_ts_data *ts)
{
	...
	input_set_abs_params(ts->input_dev, ABS_X, 0, 1024/*ts->config_info.screen_max_x*/, 0, 0);
	input_set_abs_params(ts->input_dev, ABS_Y, 0, 600/*ts->config_info.screen_max_y*/, 0, 0);
